...
// Import premium luxury designs generated by model or preloaded in the asset catalog
// @ts-ignore
import luxuryApparelDesign from "../assets/images/luxury_apparel_design_1783827281300.jpg";
// @ts-ignore
import japaneseWave from "../assets/images/japanese_wave_artwork_1783600448459.jpg";
// @ts-ignore
import sacredGeometry from "../assets/images/sacred_geometry_mandala_1783601536580.jpg";

// Professional procedural vector SVG sample logos and ultra-premium custom images
const SAMPLE_LOGOS = [
  {
    id: "luxury-apparel-design",
    name: "Luxury Phoenix (Premium)",
    src: luxuryApparelDesign,
    isImage: true
  },
  {
  ...
  {
    id: "japanese-wave-artwork",
    name: "Japanese Wave (Premium)",
    src: japaneseWave,
    isImage: true
  },
  {
    id: "sacred-geometry-mandala",
    name: "Cosmic Mandala (Premium)",
    src: sacredGeometry,
    isImage: true
  },
  {
...
export default function LogoGenerator({ onLogoSelected, activeLogo, bgRemoval, onBgRemovalChange }: LogoGeneratorProps) {
  ...
  const selectSampleLogo = (sample: typeof SAMPLE_LOGOS[0]) => {
    let dataUrl = "";
    if ("src" in sample && sample.src) {
      dataUrl = sample.src;
    } else if ("svg" in sample && sample.svg) {
      dataUrl = `data:image/svg+xml;utf8,${encodeURIComponent(sample.svg)}`;
    } else {
      return;
    }
        ...
        <div className="grid grid-cols-4 gap-2">
          {SAMPLE_LOGOS.map((sample) => {
            ...
            return (
              ...
              >
                <div 
                  className="w-12 h-12 flex items-center justify-center bg-zinc-950 rounded-lg border border-white/5 mb-1.5 p-1 overflow-hidden"
                >
                  {"svg" in sample && sample.svg ? (
                    <div className="w-full h-full flex items-center justify-center" dangerouslySetInnerHTML={{ __html: sample.svg }} />
                  ) : "src" in sample && sample.src ? (
                    <img src={sample.src} alt={sample.name} className="w-full h-full object-contain" />
                  ) : null}
                </div>
